...
public class Face {
    ...
    public static BIF createBIF(int num_bands, int num_rotations)
    {
        ...
        BIF retVal = new BIF(createBIF_0(num_bands, num_rotations));
    ...
    public static BIF createBIF()
    {
        ...
        BIF retVal = new BIF(createBIF_1());
    ...
    // C++:  Ptr_BIF createBIF(int num_bands = 8, int num_rotations = 12)
    private static native long createBIF_0(int num_bands, int num_rotations);
    private static native long createBIF_1();
